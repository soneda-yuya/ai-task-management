...
- [ ] Step ND-G1: 回答を読み込み方針確定
- [ ] Step ND-G2: `aidlc-docs/construction/U-A/nfr-design/nfr-design-patterns.md` を生成
  - [ ] レジリエンス、スケーラビリティ、パフォーマンス、セキュリティの設計パターン
  - [ ] 各 NFR を満たすための Terraform リソース設定マッピング
- [ ] Step ND-G3: `aidlc-docs/construction/U-A/nfr-design/logical-components.md` を生成
  - [ ] VPC、VPC Connector、SA、Secret、Pub/Sub 等の論理コンポーネント定義
  - [ ] 各コンポーネントの関係・連携パターン
- [ ] Step ND-G4: `aidlc-state.md` を更新
