...
- [x] Step G1: 回答を読み込み、承認されたメソドロジーを確定
- [x] Step G2: `aidlc-docs/inception/user-stories/personas.md` を生成(P1, P2 に基づく)
- [x] Step G3: エピック構造を決定(P6)、ドメイン分類を確定(P5)
- [x] Step G4: `aidlc-docs/inception/user-stories/stories.md` を生成
  - [x] P4 のテンプレートでストーリーを記述
  - [x] P7 / P8 の書式・詳細度で受入条件を記述
  - [x] P9 に従い AI エージェント挙動のシステムストーリーを(選択時は)含める
  - [x] P10 に従いセキュリティ / PBT 要件を(選択時は)独立ストーリー化
  - [x] P11 の方法で優先度を付与
- [x] Step G5: INVEST(Independent / Negotiable / Valuable / Estimable / Small / Testable)チェックを全ストーリーに適用
- [x] Step G6: 要件ドキュメントの各 FR/NFR と stories の対応マップを stories.md に含める(トレーサビリティ)
- [x] Step G7: ペルソナ→関連ストーリーのマッピングを personas.md に含める
- [x] Step G8: `aidlc-docs/aidlc-state.md` の進捗を更新
- [x] Step G9: 完了メッセージを提示、ユーザー承認を待つ
